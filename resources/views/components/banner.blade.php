...
<div class="bg-custom-gradient text-white flex flex-col md:flex-row items-center justify-center gap-4 m-3">
    <div class="text-center md:text-left p-6">
        ...
        <p class="mt-2 text-sm md:text-base max-w-md">
            En su portal web encontrarás información sobre nuestros desarrollos basados en FUVIDIT. Estás a solo un clic de conocer innovaciones y desarrollos para el transporte venezolano aquí.
        </p>
    </div>
    <div>
