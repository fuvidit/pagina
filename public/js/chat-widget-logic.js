document.addEventListener('DOMContentLoaded', function () {
    ...
    const idleVideoSrc = '{{ asset('images/videos/hfm.mp4') }}';
    // Define un video para el saludo inicial
    const saludoVideoSrc = '{{ asset('images/videos/hfm.mp4') }}';
    ...
    const responses = {
        ...
        'significa' : {
            ...
            video: '{{ asset('images/videos/significado.mp4') }}'
        },
        'objetivo' : {
        ...
        'visión' : {
            ...
            video: '{{ asset('images/videos/vision.mp4') }}'
        },
        'ubicacion' : {
            ...
            video: '{{ asset('images/videos/ubicacion.mp4') }}'
        },
        'contacto' : {
            text: 'Teléfono: (0212) 235 06 40\nCorreo electrónico: despfuvidit@gmail.com',
            video: '{{ asset('images/videos/contacto.mp4') }}'
        },
        'creacion' : {
            ...
            video: '{{ asset('images/videos/creacion.mp4') }}'
        },
        'fuvidit' : {
            text: 'La FUVIDIT se encarga de gestionar procesos de investigación, desarrollo e innovación de sistemas de transporte multimodo nacional e internacional...',
            video: '{{ asset('images/videos/funcion.mp4') }}'
