    ...
    <div class="min-h-screen flex">
        ...
        <div class="w-full md:w-1/2 bg-white-600 p-8 flex items-center justify-center">
            <div class="w-full max-w-md space-y-8">
                ...
                <form class="mt-8 space-y-6" action="{{ route('noticias.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="space-y-4">
        ...
        <div class="hidden md:block w-1/2 bg-cover bg-center" style="background-image: url('../../images/prensa.jpg');">
